...
export default function Text2ImageModel({data, id, isViewMode = false}) {
    Text2ImageModel.propTypes = {
                ...
                <div className="form-control">
                    ...
                    <div className="form-control">
                        <div className="mt-2 px-2 border-box  w-full  gap-4 self-center pt-2 form-control">
                            <div>
                                <label htmlFor="model_select" className="mb-2 label-text">图片生成模型</label>
                                <select
                                    name="model_select"
