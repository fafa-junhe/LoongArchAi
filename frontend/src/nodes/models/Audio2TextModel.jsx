...
export default function Audio2TextModel({data, id, isViewMode = false}) {
    Audio2TextModel.propTypes = {
                ...
                <div className="form-control">
                    ...
                    <div className="form-control">
                        <div className="mt-2 px-2 border-box  w-full  gap-4 self-center pt-2 form-control">
                            <div>
                                <label htmlFor="model_select" className="mb-2 label-text">语音识别模型</label>
                                <select
                                    name="model_select"
